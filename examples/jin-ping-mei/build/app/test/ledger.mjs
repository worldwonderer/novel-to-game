...
test('v5 存档按 visit_start 回填拜访次数后迁入 v6',()=>{const old=E.newGame(1);old.version=5;delete old.visits;old.history=[{day:1,type:'visit_start',heroine:'li_pinger'},{day:1,type:'visit_choice',heroine:'li_pinger'},{day:2,type:'visit_start',heroine:'li_pinger'},{day:3,type:'visit_start',heroine:'wu_yueniang'}];const loaded=E.deserialize(JSON.stringify(old));eq(loaded.version,6);eq(loaded.visits,{wu_yueniang:1,pan_jinlian:0,li_pinger:2})});
