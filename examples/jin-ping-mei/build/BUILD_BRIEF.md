...
- 年龄门只请求 cover 与 compound，传输低于 1 MiB；确认前 adult asset requests 必须为 0，之后再按安全层与成人层分批加载。

### 界面

- 390×844、768×1024、1024×768、1280×800 与 1920×1080 不得水平溢出；所有 enabled 控件位于视口内。
- 常驻 HUD 只保留日数、幕名与一条必要急报；六项定性资源、五人关系、院间信任、最近账页和宅中人收入玩家主动打开的“宅门账册”。选择、回应和过场等主游玩面板不得出现内部滚动条；只有账册、场景册、后日谈和命数档案等明确书页允许纵向滚动。
