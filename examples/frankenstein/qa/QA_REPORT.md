...
| Browser assertions | **147 passed, 0 failed** across five passes: keyboard, mouse, keyboard campaign, mouse campaign, `seen` ending, plus a card-layout gate over 2898 layouts |
