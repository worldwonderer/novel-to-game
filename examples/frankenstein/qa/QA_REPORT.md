...
| Browser assertions | **152 passed, 0 failed** across five passes: keyboard, mouse, keyboard campaign, mouse campaign, `seen` ending, plus a card-layout gate over 2898 layouts |
...
Machine-readable summary: `qa/evidence/automated.json`. Frames: `qa/evidence/browser/` (34).
