...
- `major`: 4 — 1 partly cleared (images done; fonts and audio outstanding), 2 **fixed**
  (F6 mouse input, F7 the `seen` ending), 1 open (F12, the hovel plate's composition)
