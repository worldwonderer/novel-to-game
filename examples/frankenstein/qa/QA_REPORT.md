...
| Browser assertions | **267 passed, 0 failed** across eight passes: keyboard, mouse, keyboard campaign, mouse campaign, and all four designed endings (`door`, `seen`, `want`, `silence`), plus a card-layout gate over 2898 layouts and a font gate proving both Caslon faces really render |
...
Machine-readable summary: `qa/evidence/automated.json`. Frames: `qa/evidence/browser/` (46).
